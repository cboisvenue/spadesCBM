...
```{r} 
library(raster)
age <- raster("data/forIan/SK_data/rasters/age1.tif")
...
small_extent <- raster("data/forIan/SK_data/SK_ReclineRuns30m/layers/age1_recliner.tif") #This is smaller
...
age <- raster("data/forIan/SK_data/SK_ReclineRuns30m/layers/age1_recliner.tif") #Using the small subset for speed
