...
These three variables can be determined if we know which spatial units we are in. As above the spatial can be provided by the gcID and that can be linked to the `spadesCBMout@.envir$cbmData@spinupParameters`.  
