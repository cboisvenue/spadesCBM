...
dist1991r <- raster(file.path("data/forIan/SK_data/CBM_GIS/disturbance/1991.tif"))
dev()
Plot(dist1991r)
...
#pick another
dist1995r <- raster(file.path("data/forIan/SK_data/CBM_GIS/disturbance/1995.tif"))
dev()
Plot(dist1995r)
