...
test_dir("C:/Celine/GitHub/spadesCBM/spadesCBMdefaults/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Celine/GitHub/spadesCBM/spadesCBMdefaults/tests/testthat/test-template.R")
