...
test_dir("C:/Celine/github/spadesCBM/spadesCBMinputsMerge/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Celine/github/spadesCBM/spadesCBMinputsMerge/tests/testthat/test-template.R")
