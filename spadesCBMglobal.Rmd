...
stopifnot(packageVersion("CBMutils") >= "0.0.5")
...
The `sim$growth_increments` are the final increments sued for the simulation which are hashed to speed up the processing time.
