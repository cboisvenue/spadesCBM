...
test_dir("C:/Celine/github/spadesCBM/spadesCBMm3ToBiomass/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Celine/github/spadesCBM/spadesCBMm3ToBiomass/tests/testthat/test-template.R")
