...
=======
moduleDir <- getwd()#file.path("C:/Celine/GitHub/spadesCBM")
inputDir <- file.path(getwd(),"data") %>% reproducible::checkPath(create = TRUE)
outputDir <- file.path(getwd(),"outputs")
cacheDir <- file.path(outputDir,"cache") # as to not to overwhelm my github I like my cache here C:\Celine\SpaDEScacheOutputs
>>>>>>> 925cdd0c21d26c2e8d9bec31b4068b8b301667db
