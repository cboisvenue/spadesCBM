...
C:\Celine\GitHub\RCBM\data\12\_Spades\_run\CBM3BaselineTesting). A map
...
\NormalTok{times <-}\StringTok{ }\KeywordTok{list}\NormalTok{(}\DataTypeTok{start =} \FloatTok{1990.00}\NormalTok{, }\DataTypeTok{end =} \FloatTok{1999.00}\NormalTok{)}
